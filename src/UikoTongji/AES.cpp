...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int AES_cbc_encrypt(const unsigned char *in, unsigned char *out, const unsigned long length, const AES_KEY *key, unsigned char *ivec, const int enc) 
{
	unsigned long n;
...
Cipher::Cipher(){ }
//AES加密
char *Cipher::aes_encode(const char *sourcestr, char *key = "")
{
    ...
    AES_KEY aes;
    //memset(aes.rd_key, 0, sizeof(aes.rd_key));
...
//AES解密
char *Cipher::aes_decode(const char *crypttext, char *key = "")
{
    if (strcmp(key, "") == 0) key = aeskey;
...
//Base64编码
char *Cipher::base64_encode(const char *data, int data_len)
{
    int prepare = 0;
        int ret_len;
        int temp = 0;
...
//Base64解码
char *Cipher::base64_decode(const char *data, int data_len, int &out_len)
{
