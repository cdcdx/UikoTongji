...
char* PrintMD5(uchar md5Digest[16])
{
	...
	{
		wsprintfA(chEach, "%02x", md5Digest[nCount]);
		lstrcatA(chBuffer, chEach /*, sizeof(chEach)*/);
	}

	char *Tmp = new char[256];
	lstrcpynA(Tmp,chBuffer,256);  Tmp[255]='0';
	return Tmp;
...
//	try
	{
		...
		if ((file = CreateFileA(szFilename, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, 0)) != INVALID_HANDLE_VALUE )
		{
